    ...
    def __init__(self):
        ...
        self.objetivos_map = {
            ...
            'renda': [
                ...
                # MELHORIAS CRÍTICAS - Respostas que não eram reconhecidas
                'gerar renda extra', 'ter renda', 'quero renda', 'renda fixa',
                'receber mensalmente', 'ganhar todo mês', 'entrada mensal'
            ],
            'aposentadoria': [
            ...
            'protecao': [
                ...
                # MELHORIAS CRÍTICAS - Frase exata dos logs
                'proteger o que já tenho', 'proteger o que tenho', 
                'manter o que tenho', 'preservar patrimônio',
                'não quero arriscar', 'segurança primeiro'
            ]
        }
